...
Previously as a graduate student at Penn,
working with [ATLAS Experiment](https://atlas.cern/)
at [CERN](https://home.cern/),
I helped commission the Transition Radiation Tracker (TRT),
...
![A display of a $pp$ &rarr; $tt$ &rarr; $bb\mu\tau$ event in ATLAS in 2011.](img/ATLAS-ttbar-tau.png)
...
![A figure I drew with [Kyle Cranmer](http://theoryandpractice.org/) of the big-picture of the flow of ATLAS data.](img/atlas-data-flow.png "Experiment &rarr; data acquisition &rarr; reconstruction &rarr; analysis &rarr; inference")

In physics, my research has primarily focused on supporting and optimizing the reconstruction
of hadronic tau decays, and searching for exotic new physics in ditau and diphoton events,
...
In April 2018, I joined [Cerebras Systems](https://www.cerebras.net)
...
Collaborators at Cerebras and I published a new normalization
technique, OnlineNorm, for training deep neural networks with small batch sizes
...
-   ATLAS tau reconstruction and identification
...
-   Development of a new type of normalization layer for training neural networks,
    [OnlineNorm](https://github.com/Cerebras/online-normalization),
